...
class GoogleMapPlotter(object):
    ...
    def draw(self, htmlfile):
        ...
        f.write('<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=INSERT_YOUR_KEY_HERE&libraries=visualization&sensor=true_or_false"></script>\n')
    ...
    def write_polyline(self, f, path, settings):
        ...
        f.write("icons: [{icon: {path: google.maps.SymbolPath.FORWARD_CLOSED_ARROW},offset: '100%'}]")
        f.write('});\n')
        f.write('\n')
